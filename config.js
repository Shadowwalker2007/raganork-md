...
module.exports = {
    ...
    SESSION: (process.env.SESSION || process.env.SESSION_ID || 'Raganork~ee772086e040c3df4eb4ff1c3d2b09f3:44585973694a554a662f303d').trim() || '',
    ...
    ALLOWED: process.env.ALLOWED || '263,263,2',
    NOT_ALLOWED: process.env.ALLOWED || '263,263',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "Shadow walker v2",
    BOT_NAME: process.env.BOT_NAME || 'SHADOW WALKER V2 BOT',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'Mandishons Innocent;shadow walker v2 bot;https://i.imgur.com/P7ziVhr.jpeg' : process.env.AUDIO_DATA,
